...
public class BackendPipelineStack extends Stack {
    ...
    public BackendPipelineStack(Construct app, String id, StackProps props) {
        ...
        PolicyStatement cdkDeployPolicyStatement = PolicyStatement.Builder.create()
                .effect(Effect.ALLOW)
                .actions(List.of(
                ...
                .resources(List.of(
                        "arn:aws:cloudformation:*:*:stack/InfrastructureStack",
                        "arn:aws:cloudformation:*:*:stack/InfrastructureStack/*"))
                .build();

        PolicyStatement iamLimitedPolicy = PolicyStatement.Builder.create()
                .effect(Effect.ALLOW)
                .actions(List.of(
                        "iam:GetRole",
                        "iam:CreateRole",
        ...
        pipelineProject.getRole().addToPrincipalPolicy(cdkDeployPolicyStatement);
